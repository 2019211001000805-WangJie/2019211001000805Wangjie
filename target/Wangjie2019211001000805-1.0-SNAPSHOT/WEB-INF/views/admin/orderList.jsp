			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.wangjie.model.Order o=(com.wangjie.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.wangjie.dao.UserDao userDao=new com.wangjie.dao.UserDao();
						...
						<%
							...
							String paymentType=com.wangjie.model.Payment.findByPaymentId(con,n);
							 %>
